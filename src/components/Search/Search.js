...
import { faClock, faFilter, faBraille, faExclamationTriangle, faExternalLinkAlt, faArrowRight, faArrowLeft, faTimes } from '@fortawesome/free-solid-svg-icons'

export default function Search({disabled, handleChange, handleSubmit}) {
            ...
            <form onSubmit={handleSubmit}>
                <div className="field has-addons has-addons-centered">
                    ...
                    <p className="control is-button" id="search-button-wrapper">
                        <button type="submit" className="button is-orange" id="search-button" onClick={handleSubmit} disabled={disabled}>Search</button>
                    </p>
                </div>
            </form>
