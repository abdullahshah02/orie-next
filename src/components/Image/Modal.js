        ...
        <div className="modal is-active" id='modal'>
            ...
            <div className="modal-card">
                <header className="modal-card-head has-text-centered">
                    <a href={post.source} target="_blank" className="modal-card-title has-text-info has-text-centered" id="post-title"><u>{post.title}</u></a>
                ...
                <footer className="modal-card-foot">
                    ...
                    <a className="button is-dark" id="full-screen" target="_blank" href={post.url}>
                        <span className="icon is-small">
