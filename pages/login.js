...
export default function Login() {
    ...
    async function handleSubmit(event) {
        ...
        try {
            ...
            document.querySelector('#login-button').classList.toggle('is-loading')
            setDisabled(true);
            setAuthError(null);
                    ...
                    <div className='column is-5-desktop is-6-tablet'>
                        <form onSubmit={handleSubmit} className="box has-background-black">
                            ...
                            <p className="control has-text-centered">
                                <button type="submit" className="button is-link" id="login-button" disabled={disabled}>Login</button>
                            </p>
