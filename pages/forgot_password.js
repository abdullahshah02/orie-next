...
export default function forgotPassword() {
    ...
    async function handleSubmit(event) {
        ...
        try {
            document.querySelector('#fp-button').classList.toggle('is-loading')
            setDisabled(true);
            setSuccess(null)
            setError(null)
                    ...
                    <div className='column is-4-desktop is-6-tablet'>
                        <form onSubmit={handleSubmit} className="box has-background-black">
                            ...
                            <p className="control has-text-centered">
                                <button className="button is-link" id="fp-button" type="submit" disabled={disabled}>Reset Password</button>
                            </p>
